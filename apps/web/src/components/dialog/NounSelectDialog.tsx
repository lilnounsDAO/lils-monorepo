              ...
              <div className="flex h-[244px] w-full flex-col items-center justify-center gap-2 px-8 py-6 text-center">
                ...
                <div className="text-content-secondary">
                  {CHAIN_CONFIG.chain.id == 1 ? (
                    <>
                      Don{"'"}t have a lil noun on Ethereum? Try Lilnouns.wtf on{" "}
                      <LinkExternal
                        className="text-semantic-accent hover:brightness-[85%]"
                        href="https://sepolia.lilnouns.wtf"
                      >
                        Sepolia Testnet
                      </LinkExternal>
                      .
                    ...
                    <>
                      You don{"'"}t have a lil noun on Testnet.
                      <br />
                      Buy a{" "}
                      <Link to="/" className="text-semantic-accent">
                        Testnet Lil Noun here
                      </Link>
                      .
                    </>
                  )}
